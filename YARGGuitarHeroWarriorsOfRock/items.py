...
if TYPE_CHECKING:
    from .world import YARGGuitarHeroWarriorsOfRockWorld
...
class YARGGuitarHeroWarriorsOfRockItem(Item):
    game = "YARGGuitarHeroWarriorsOfRock"


def get_random_filler_item_name(world: YARGGuitarHeroWarriorsOfRockWorld) -> str:
    return "Star Power Bonus"


def create_item_with_correct_classification(world: YARGGuitarHeroWarriorsOfRockWorld, name: str) -> YARGGuitarHeroWarriorsOfRockItem:
    classification = DEFAULT_ITEM_CLASSIFICATIONS[name]

    return YARGGuitarHeroWarriorsOfRockItem(name, classification, ITEM_NAME_TO_ID[name], world.player)


def create_all_items(world: YARGGuitarHeroWarriorsOfRockWorld) -> None:
    itempool: list[Item] = []
