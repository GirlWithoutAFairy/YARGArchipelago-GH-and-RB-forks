...
from . import options as YARGGuitarHeroWarriorsOfRock_options
...
class YARGGuitarHeroWarriorsOfRock(World):
    """
    ...
    web = web_world.YARGGuitarHeroWarriorsOfRockWebWorld()

    options_dataclass = YARGGuitarHeroWarriorsOfRock_options.YARGGuitarHeroWarriorsOfRockOptions
    options: YARGGuitarHeroWarriorsOfRock_options.YARGGuitarHeroWarriorsOfRockOptions
    ...
    def generate_early(self) -> None:
        ...
        if set(enabledsets) == set():
            enabledsets.add("GuitarHeroWarriorsOfRock")
    ...
    def create_item(self, name: str) -> items.YARGGuitarHeroWarriorsOfRockItem:
