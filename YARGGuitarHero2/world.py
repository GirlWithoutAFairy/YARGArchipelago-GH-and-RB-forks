...
from . import options as YARGGuitarHero2_options
...
class YARGGuitarHero2(World):
    ...
    web = web_world.YARGGuitarHero2WebWorld()

    options_dataclass = YARGGuitarHero2_options.YARGGuitarHero2Options
    options: YARGGuitarHero2_options.YARGGuitarHero2Options
    ...
    def create_item(self, name: str) -> items.YARGGuitarHero2Item:
