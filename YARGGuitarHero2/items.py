...
if TYPE_CHECKING:
    from .world import YARGGuitarHero2World
...
class YARGGuitarHero2Item(Item):
    game = "YARGGuitarHero2"


def get_random_filler_item_name(world: YARGGuitarHero2World) -> str:
    return "Star Power Bonus"


def create_item_with_correct_classification(world: YARGGuitarHero2World, name: str) -> YARGGuitarHero2Item:
    classification = DEFAULT_ITEM_CLASSIFICATIONS[name]

    return YARGGuitarHero2Item(name, classification, ITEM_NAME_TO_ID[name], world.player)


def create_all_items(world: YARGGuitarHero2World) -> None:
    itempool: list[Item] = []
