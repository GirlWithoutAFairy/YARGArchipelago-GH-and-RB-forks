...
class EnabledSetlists(OptionSet):
    ...
    defaultsetlist = ['Guitar Hero World Tour']
...
@dataclass
class YARGGuitarHeroWorldTourOptions(PerGameCommonOptions):
...
option_groups = [
    ...
    OptionGroup(
        "Instrument Shuffle",
        [InstrumentShuffle, ShuffleGuitar, ShuffleBass, ShuffleDrums, 
        ShuffleRhythm, ShuffleVocals]
    ),
    OptionGroup(
        "Visibility Options",
        [GoalSongVisibility]
