...
from . import options as YARGGuitarHeroWorldTour_options
...
class YARGGuitarHeroWorldTour(World):
    """
    ...
    web = web_world.YARGGuitarHeroWorldTourWebWorld()

    options_dataclass = YARGGuitarHeroWorldTour_options.YARGGuitarHeroWorldTourOptions
    options: YARGGuitarHeroWorldTour_options.YARGGuitarHeroWorldTourOptions
    ...
    def generate_early(self) -> None:
        ...
        if set(enabledsets) == set():
            enabledsets.add("Guitar Hero World Tour")
    ...
    def create_item(self, name: str) -> items.YARGGuitarHeroWorldTourItem:
