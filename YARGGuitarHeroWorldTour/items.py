...
if TYPE_CHECKING:
    from .world import YARGGuitarHeroWorldTourWorld
...
class YARGGuitarHeroWorldTourItem(Item):
    game = "YARGGuitarHeroWorldTour"


def get_random_filler_item_name(world: YARGGuitarHeroWorldTourWorld) -> str:
    return "Star Power Bonus"


def create_item_with_correct_classification(world: YARGGuitarHeroWorldTourWorld, name: str) -> YARGGuitarHeroWorldTourItem:
    classification = DEFAULT_ITEM_CLASSIFICATIONS[name]

    return YARGGuitarHeroWorldTourItem(name, classification, ITEM_NAME_TO_ID[name], world.player)


def create_all_items(world: YARGGuitarHeroWorldTourWorld) -> None:
    itempool: list[Item] = []
