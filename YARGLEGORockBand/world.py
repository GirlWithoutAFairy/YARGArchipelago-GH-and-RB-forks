...
from . import options as YARGLEGORockBand_options
...
class YARGLEGORockBand(World):
    ...
    web = web_world.YARGLEGORockBandWebWorld()

    options_dataclass = YARGLEGORockBand_options.YARGLEGORockBandOptions
    options: YARGLEGORockBand_options.YARGLEGORockBandOptions
    ...
    def create_item(self, name: str) -> items.YARGLEGORockBandItem:
