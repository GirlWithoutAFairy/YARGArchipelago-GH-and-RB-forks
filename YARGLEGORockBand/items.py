...
class YARGLEGORockBandItem(Item):
    game = "YARGLEGORockBand"


def get_random_filler_item_name(world: YARGLEGORockBandWorld) -> str:
    return "Star Power Bonus"


def create_item_with_correct_classification(world: YARGLEGORockBandWorld, name: str) -> YARGLEGORockBandItem:
    classification = DEFAULT_ITEM_CLASSIFICATIONS[name]

    return YARGLEGORockBandItem(name, classification, ITEM_NAME_TO_ID[name], world.player)


def create_all_items(world: YARGLEGORockBandWorld) -> None:
    itempool: list[Item] = []
