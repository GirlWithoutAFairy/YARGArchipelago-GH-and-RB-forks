...
if TYPE_CHECKING:
    from .world import YARGRockBand2World
...
class YARGRockBand2Item(Item):
    game = "YARGRockBand2"


def get_random_filler_item_name(world: YARGRockBand2World) -> str:
    return "Star Power Bonus"


def create_item_with_correct_classification(world: YARGRockBand2World, name: str) -> YARGRockBand2Item:
    classification = DEFAULT_ITEM_CLASSIFICATIONS[name]

    return YARGRockBand2Item(name, classification, ITEM_NAME_TO_ID[name], world.player)


def create_all_items(world: YARGRockBand2World) -> None:
    itempool: list[Item] = []
