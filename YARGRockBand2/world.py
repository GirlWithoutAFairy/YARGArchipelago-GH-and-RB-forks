...
from . import options as YARGRockBand2_options
...
class YARGRockBand2(World):
    ...
    web = web_world.YARGRockBand2WebWorld()

    options_dataclass = YARGRockBand2_options.YARGRockBand2Options
    options: YARGRockBand2_options.YARGRockBand2Options
    ...
    def create_item(self, name: str) -> items.YARGRockBand2Item:
