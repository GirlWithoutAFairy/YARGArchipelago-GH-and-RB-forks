...
from . import options as YARGBandHero_options
...
class YARGBandHero(World):
    ...
    web = web_world.YARGBandHeroWebWorld()

    options_dataclass = YARGBandHero_options.YARGBandHeroOptions
    options: YARGBandHero_options.YARGBandHeroOptions
    ...
    def create_item(self, name: str) -> items.YARGBandHeroItem:
