...
if TYPE_CHECKING:
    from .world import YARGBandHeroWorld
...
class YARGBandHeroItem(Item):
    game = "YARGBandHero"


def get_random_filler_item_name(world: YARGBandHeroWorld) -> str:
    return "Star Power Bonus"


def create_item_with_correct_classification(world: YARGBandHeroWorld, name: str) -> YARGBandHeroItem:
    classification = DEFAULT_ITEM_CLASSIFICATIONS[name]

    return YARGBandHeroItem(name, classification, ITEM_NAME_TO_ID[name], world.player)


def create_all_items(world: YARGBandHeroWorld) -> None:
    itempool: list[Item] = []
