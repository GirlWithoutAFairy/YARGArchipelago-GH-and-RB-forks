...
if TYPE_CHECKING:
    from .world import YARGGuitarHero3World
...
class YARGGuitarHero3Item(Item):
    game = "YARGGuitarHero3"


def get_random_filler_item_name(world: YARGGuitarHero3World) -> str:
    return "Star Power Bonus"


def create_item_with_correct_classification(world: YARGGuitarHero3World, name: str) -> YARGGuitarHero3Item:
    classification = DEFAULT_ITEM_CLASSIFICATIONS[name]

    return YARGGuitarHero3Item(name, classification, ITEM_NAME_TO_ID[name], world.player)


def create_all_items(world: YARGGuitarHero3World) -> None:
    itempool: list[Item] = []
