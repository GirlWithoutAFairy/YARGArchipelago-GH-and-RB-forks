...
from . import options as YARGGuitarHero3_options
...
class YARGGuitarHero3(World):
    ...
    web = web_world.YARGGuitarHero3WebWorld()

    options_dataclass = YARGGuitarHero3_options.YARGGuitarHero3Options
    options: YARGGuitarHero3_options.YARGGuitarHero3Options
    ...
    def create_item(self, name: str) -> items.YARGGuitarHero3Item:
