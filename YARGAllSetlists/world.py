...
from . import options as YARGAllSetlists_options
...
class YARGAllSetlists(World):
    ...
    web = web_world.YARGAllSetlistsWebWorld()

    options_dataclass = YARGAllSetlists_options.YARGAllSetlistsOptions
    options: YARGAllSetlists_options.YARGAllSetlistsOptions
    ...
    def create_item(self, name: str) -> items.YARGAllSetlistsItem:
