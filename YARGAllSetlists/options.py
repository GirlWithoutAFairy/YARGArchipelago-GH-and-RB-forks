...
class ExcludedSongs(OptionSet):
    ...
    "Song Name" by Artist from Source

    Example:
    "Killer Queen" by Queen (WaveGroup) from gh1

    Sources: yarg, yargdlc, yarn, gh1, ghwt, rb3
    """
...
@dataclass
class YARGAllSetlistsOptions(PerGameCommonOptions):
